public class Car {
    ...
    //Overload методів, що є одної з складових поліморфізму
    public void changeSomething(Engine newEngine){
        this.engine = newEngine;
        System.out.println("Мотор успішно змінено!");
    }
    public void changeSomething(Wheel newWheel){
        this.wheels[0] = newWheel;
        System.out.println("Колесо успішно змінено!");
    }
    public void changeSomething(String color){
        setColor(color);
        System.out.println("Колір успішно змінено!");
    }

    public void drive(){
        System.out.println("Ви їдете машиною!");
    }
